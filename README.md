...
- **Interactive Playlist**: Slide-out menu to view and select tracks.
...
- **JavaScript (Vanilla)**: For the custom audio engine and UI logic.
- **FontAwesome**: For premium interface icons.
...
- `script.js`: Audio logic and UI interactivity.
- `assets/`: 
